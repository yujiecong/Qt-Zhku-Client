...
public:
    ...
    void setupUi(QWidget *FuncTable)
    {
        if (FuncTable->objectName().isEmpty())
            FuncTable->setObjectName(QString::fromUtf8("FuncTable"));
        FuncTable->resize(183, 45);
        ...
        FuncTable->setMinimumSize(QSize(0, 45));
        FuncTable->setMaximumSize(QSize(16777215, 20));
        horizontalLayout = new QHBoxLayout(FuncTable);
        horizontalLayout->setSpacing(0);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        curriculumArrangement = new QWidget(FuncTable);
        curriculumArrangement->setObjectName(QString::fromUtf8("curriculumArrangement"));
        ...
        curriculumArrangement->setStyleSheet(QString::fromUtf8("border-radius:10px"));
    ...
    {
        FuncTable->setWindowTitle(QCoreApplication::translate("FuncTable", "Form", nullptr));
        iconLabel->setText(QString());
        textLabel->setText(QCoreApplication::translate("FuncTable", "\346\225\231\345\255\246\345\256\211\346\216\222", nullptr));
