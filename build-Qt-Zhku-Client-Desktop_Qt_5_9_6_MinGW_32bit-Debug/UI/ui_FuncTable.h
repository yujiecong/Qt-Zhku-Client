...
public:
    ...
    void setupUi(QWidget *FuncTable)
    {
        ...
        FuncTable->setMinimumSize(QSize(211, 34));
        FuncTable->setMaximumSize(QSize(211, 34));
        ...
        arrowLabel->setPixmap(QPixmap(QString::fromUtf8(":/assets/btnIcon/\344\271\246.svg")));
