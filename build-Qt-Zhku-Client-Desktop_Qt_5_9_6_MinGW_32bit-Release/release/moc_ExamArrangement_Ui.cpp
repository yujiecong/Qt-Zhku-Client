...
#include "../../Qt-Zhku-Client/ExamArrangement_Ui.h"
...
void ExamArrangement_Ui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ExamArrangement_Ui *_t = static_cast<ExamArrangement_Ui *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ExamArrangement_Ui::*_t)();
        ...
        {
            typedef void (ExamArrangement_Ui::*_t)(const int );
...
const QMetaObject ExamArrangement_Ui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ExamArrangement_Ui.data,
      qt_meta_data_ExamArrangement_Ui,  qt_static_metacall, nullptr, nullptr}
};
