...
QT_MOC_LITERAL(1, 11, 10), // "getCodeImg"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 21) // "on_pushButton_clicked"

    },
    "MoreWidget\0getCodeImg\0\0on_pushButton_clicked"
};
...
void MoreWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MoreWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MoreWidget::getCodeImg)) {
                *result = 0;
                return;
            }
        }
